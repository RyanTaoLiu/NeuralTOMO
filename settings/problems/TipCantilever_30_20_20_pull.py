...
class TipCantilever_30_20_20_pull(problemBase):
    problemName = 'TipCantilever_30_20_20_pull'

    def __init__(self):
        super().__init__()
        self.name = 'TipCantilever_30_20_20_pull'
...
if __name__ == '__main__':
    mbb_problem = TipCantilever_30_20_20_pull()
